...
INPUT_VALUES = [
    ([], {}),
    ([(1, 'a'), (2, 'b'), (3, 'c')], {'1': ['a'], '2': ['b'], '3': ['c']}, 'a'),
    ([(2, 'a'), (5, 'b'), (12, 'c')], {'2': ['a'], '5': ['b'], '12': ['c']}, 'a'),
    ([(15, 'words'), (6, 'are'), (70, 'hard')], {'6': ['are'], '15': ['words'], '70': ['hard']}, 'are'),
    ([(1, 15), (2, 20), (3, 25)], {'1': [15], '2': [20], '3': [25]}, 15),
    ([(1, 'a'), (1, 'b'), (2, 'c')], {'1': ['a', 'b'], '2': ['c']}, 'a'),
]
...
def pri(request):
    ...
    prioq = (processed, request.param[1], request.param[2])
    return prioq
